...
class Cart extends Component {
  ...
  componentDidUpdate(prevProps){
        if(this.props.cartItems2.cartItems.totalSumPrice !== this.state.total)
        {
          this.updateCart();
        }
  }
  ...
  applyCouponCart = coupon => {
    ...
    if (
      ...
      this.setState({ wrapperAlert: false, SpinnerTemp: false });
      return 0;
    }
  ...
  render() {
    ...
    return this.state.activityIndicatorTemp ? (
      ...
      <View style={{ flex: 1 }}>
        ...
        >
          <Text style={{ fontSize: themeStyle.largeSize, padding: 5, fontWeight: '600', color: '#000' }}>
            Demo Coupons{' '}
          </Text>
          <View>
            <View
          ...
          renderItem={item => (
            <View>
              ...
              >
                ...
                >
                  <Text style={{ textAlign: 'left', fontSize: themeStyle.smallSize }}>{item.item.name}</Text>
                </View>
                    ...
                    onPress={() =>
                      this.props.navigation.push('ProductDetails', {
                        objectArray: this.props.cartItems2.cartItems
                          ...
                          updateCart: () => this.setState({ activityIndicatorTemp: true }, () => {
                            this.updateCart();
                          })
                         ,
                      })
                    }
                    title={" "+this.props.cartItems2.Config.languageJson.View+" "}
                    color={themeStyle.otherBtnsColor}
                  
                  />
                  <View style={{ marginLeft: 18, marginTop: Platform.OS === 'ios' ? 2 : 0  }}>
                  <TouchableOpacity
              style={{
