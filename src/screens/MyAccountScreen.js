...
class CreateAccount extends Component {
  ...
  updateInfo = (t) => {
    ...
    t.UpdateCustomerData1(SyncStorage.get('customerData').id, t.state.myAccountData);
  }
  //////////////////////////////////////////////////////
  ...
  signUp =(t, nonce) => {
    ...
    fetch(
      `${
        this.props.isLoading.Config.url
      }/api/reactappusers/react_register/?insecure=cool`,
      {
        method: 'POST',
        body: formData,
      }
      ...
      .then(data => {
        if (data.status === 'ok') {
          t.setState({ errorMessage: 'User Created. Login Using your Username & Password', spinnerTemp: false });
        } else {
        ...
        >
          ...
          >
            <TextInput
              ...
              placeholder={this.props.isLoading.Config.languageJson['First Name']}
            ...
            <TextInput
              ...
              selectionColor="#51688F"
              placeholder={this.props.isLoading.Config.languageJson['Last Name']}
            ...
            <TextInput
              style={{
                ...
                fontSize: themeStyle.mediumSize,
                paddingLeft: 4,
                textAlign: I18nManager.isRTL ? Platform.OS === 'android' ? 'right' : 'auto' : 'auto'
              }}
              secureTextEntry
              selectionColor="#51688F"
            ...
            >
              <View
                style={{
                  ...
                  justifyContent: 'center',
                  opacity: this.state.firstName === '' || this.state.lastName === '' 
                  || this.state.userName === '' || this.state.email === '' || this.state.password === ''
                   === '' ? 0.4 : 0.9
                }}
              >
                <Text
                  style={{ textAlign: 'center', color: '#fff', fontSize: themeStyle.mediumSize, fontWeight: '500' }}
                >
