      ...
      >
        ...
        >
          <Text
            style={{
              color:
                name === 'Country' || name === 'State' ? '#c0c0c0' : 'black',
        ...
        <View>
          {this.searchFilterFun(
            global.data.countries,
             this.state.shippingCountry === '' ? placeholderText : this.state.shippingCountry,
            'shipping'
          )}
        </View>
    ...
    return placeholderText ===
      this.props.cartItems2.Config.languageJson.Country ? (
        <View>
          {this.searchFilterFun(
            global.data.countries,
            this.state.billingArray[5] === '' ? placeholderText : this.state.billingArray[5],
            'billing'
          )}
        </View>
      ) : placeholderText === this.props.cartItems2.Config.languageJson.State ? (
    ...
    return placeholderText ===
      this.props.cartItems2.Config.languageJson.Country ? (
        <View>
          {this.searchFilterFun(
            global.data.countries,
            this.state.shippingArray[5] === '' ? placeholderText : this.state.shippingArray[5],
            'shipping'
          )}
        </View>
      ) : placeholderText === this.props.cartItems2.Config.languageJson.State ? (
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <Text
                  style={{ textAlign: 'center', color: '#fff', fontSize: theme.mediumSize + 1 }}
                >
