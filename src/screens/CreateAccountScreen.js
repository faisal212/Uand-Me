...
import { Text, View, TextInput, TouchableOpacity, Platform, I18nManager } from 'react-native';
      ...
      <KeyboardAwareScrollView style={{ backgroundColor: '#f4f4f4' }}>
        ...
        >
          ...
          >
            ...
            >
              {this.props.isLoading.Config.languageJson['Creating an account means you\u2019re okay with our'] }
              <Text
                onPress={() => {
