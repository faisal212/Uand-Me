...
const cartItems = (state = initialState, action) => {
  ...
  switch (action.type) {
    case 'GET_ALL_CATEGORIES':
      ...
      return {
        cartProductArray: [...state.cartProductArray],
        cartquantity: state.cartquantity,
        subTotal: [...state.subTotal],
        totalSumPrice: state.totalSumPrice,
        spinerTemp: state.spinerTemp,
        indicatorTemp: state.indicatorTemp,
        spinnerArray: [...state.spinnerArray],
        recentViewedProducts: [...state.recentViewedProducts],
        wishListProducts: [...state.wishListProducts],
        removerecentCondition: state.removerecentCondition,
        onScreen: state.onScreen,
        couponArray: [...state.couponArray],
