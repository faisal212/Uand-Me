        ...
        >
          <View style={styles.tabComponents}>
            {!this.props.isLoading.Config.defaultIcons ? (
              <ImageLoad
                key={0}
                style={{ width: 25, height: 25, marginRight: I18nManager.isRTL ? 8 : 4, marginLeft: 0 }}
              ...
              <Icon name={iconName} size={20} style={{ color: '#4d4d4d', paddingLeft: I18nManager.isRTL ? 1 : 0, paddingRight: 3 }} />
            )}
               ...
               this.state.AccordionData.map((item, key) => (
                ...
                {this.props.isLoading.Config.shareApp ? (
                  <ShareAppButton
                    ...
                    iconName={'share'}
                    style={{ fontSize: theme.smallSize, paddingRight: 8, paddingLeft: 8 }}
